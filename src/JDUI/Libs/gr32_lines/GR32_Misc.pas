...
begin
  ...
  begin
    ...
    Math.SinCos(eccentric_angle_radians, SinAng, CosAng);
...
begin
  ...
  begin
    Math.SinCos(angle_delta *i, sinA, cosA);
...
begin
  ...
  gr32.offsetRect(rec3, -rec3.Left, -rec3.Top);
  offsetPoint(rotPoint, -rec2.Left, -rec2.Top);
  gr32.offsetRect(rec2, -rec2.Left, -rec2.Top);
