...
type
  ...
  public
    { Public declarations }
    Source: TMultiImage;//TSingleImage;
...
begin
  ...
  begin
    ...
    begin
      ...
      Source.LoadMultiFromFile(Filename);
      //Image.SetBounds(Image.Left, Image.Top, Source.Width, Source.Height);
      //if Source.ImageCount>1 then
      //begin
      Source.ActiveImage:=2;
      Source.ResizeImages(48,48,rfBicubic);
      //Image.Canvas.Draw(0,0,TGraphic(source));
      Image.Picture.Graphic.Assign(Source);
