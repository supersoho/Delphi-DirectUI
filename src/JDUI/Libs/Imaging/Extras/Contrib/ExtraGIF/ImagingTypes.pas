{
  $Id: ImagingTypes.pas 169 2009-08-22 18:54:21Z galfar $
...
const
  ...
  {This option makes gif loading using disposal algorithm}
  ImagingLoadAnimated         = 132;
...
type
  ...
  TExtraClass = class of TExtraData;
...
procedure TExtraData.AssignFrom(Source: TExtraData);
begin
  Delay := Source.Delay;
end;

procedure TExtraData.ContentChanged(const Bits, Palette: Pointer);
begin
  //nothing here
end;

procedure TExtraData.ImageResized(var NewWidth, NewHeight: Integer);
begin
  //nothing here
end;
