...
begin
  ...
  begin
    ...
    OldMode := WinApi.Windows.SetStretchBltMode(DC, COLORONCOLOR);
    ...
    try
       with SrcRect, ImageData do
        if WinApi.Windows.StretchDIBits(DC, DstRect.Left, DstRect.Top,
      ...
      WinApi.Windows.SetStretchBltMode(DC, OldMode);
    end;
  end;
end;
{$ENDIF}
