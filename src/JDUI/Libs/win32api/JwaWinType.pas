...
//
  ...
  UCHAR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.UCHAR{$ELSE}Char{$ENDIF};
  {$EXTERNALSYM UCHAR}
  USHORT = Word;
  {$EXTERNALSYM USHORT}
  ULONG = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.ULONG{$ELSE}Longword{$ENDIF};
  {$EXTERNALSYM ULONG}
  UQUAD = QUAD;
  {$EXTERNALSYM UQUAD}
...
type
  LONGLONG = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LONGLONG{$ELSE}Int64{$ENDIF};
...
type
  ...
  BOOL = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.BOOL{$ELSE}LongBool{$ENDIF};
  {$EXTERNALSYM BOOL}

  DWORD = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.DWORD{$ELSE}Longword{$ENDIF};
  {$EXTERNALSYM DWORD}
...
//
  ...
  SHORT = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.SHORT{$ELSE}Smallint{$ENDIF};
  {$EXTERNALSYM SHORT}
  LONG = Longint;
  {$EXTERNALSYM LONG}
...
//
  ...
  WCHAR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.WCHAR{$ELSE}WideChar{$ENDIF};
  {$EXTERNALSYM WCHAR}

  PWCHAR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PWChar{$ELSE}^WCHAR{$ENDIF};
  {$EXTERNALSYM PWCHAR}
  LPWCH = ^WCHAR;
  {$EXTERNALSYM LPWCH}
  PWCH = ^WCHAR;
  ...
  NWPSTR = ^WCHAR;
  {$EXTERNALSYM NWPSTR}
  LPWSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPWSTR{$ELSE}^WCHAR{$ENDIF};
  {$EXTERNALSYM LPWSTR}
  LPCWSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPCWSTR{$ELSE}^WCHAR{$ENDIF};
  {$EXTERNALSYM LPCWSTR}
  PWSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPWSTR{$ELSE}^WCHAR{$ENDIF};
  {$EXTERNALSYM PWSTR}
  LPUWSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPWSTR{$ELSE}^WCHAR{$ENDIF};
  {$EXTERNALSYM LPUWSTR}
  PUWSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPWSTR{$ELSE}^WCHAR{$ENDIF};
  {$EXTERNALSYM PUWSTR}
  LCPUWSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPWSTR{$ELSE}^WCHAR{$ENDIF};
  {$EXTERNALSYM LCPUWSTR}
  PCUWSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPWSTR{$ELSE}^WCHAR{$ENDIF};
  {$EXTERNALSYM PCUWSTR}
...
//
  ...
  NPSTR = ^CHAR;
  {$EXTERNALSYM NPSTR}
  LPSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPSTR{$ELSE}^CHAR{$ENDIF};
  {$EXTERNALSYM LPSTR}
  PSTR = {$IFDEF USE_DELPHI_TYPES}PChar{$ELSE}^CHAR{$ENDIF};
  {$EXTERNALSYM PSTR}
  LPCSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPCSTR{$ELSE}^CHAR{$ENDIF};
  {$EXTERNALSYM LPCSTR}
...
{$IFDEF UNICODE}
  ...
  PTSTR = LPWSTR;
  {$EXTERNALSYM PTSTR}
  LPTSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPTSTR{$ELSE}LPWSTR{$ENDIF};
  {$EXTERNALSYM LPTSTR}
  PCTSTR = LPCWSTR;
  {$EXTERNALSYM PCTSTR}
  LPCTSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPCTSTR{$ELSE}LPCWSTR{$ENDIF};
  {$EXTERNALSYM LPCTSTR}

  PCUTSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPCTSTR{$ELSE}LPCWSTR{$ENDIF};
  {$EXTERNALSYM PCUTSTR}
  LPCUTSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPCTSTR{$ELSE}LPCWSTR{$ENDIF};
  {$EXTERNALSYM LPCUTSTR}
  PUTSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPCSTR{$ELSE}LPCWSTR{$ENDIF};
  {$EXTERNALSYM PUTSTR}
  LPUTSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPCSTR{$ELSE}LPCWSTR{$ENDIF};
  {$EXTERNALSYM LPUTSTR}
...
{$ELSE}
  ...
  PTSTR = LPSTR;
  {$EXTERNALSYM PTSTR}
  LPTSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPTSTR{$ELSE}LPSTR{$ENDIF};
  {$EXTERNALSYM LPTSTR}
  PCTSTR = LPCSTR;
  {$EXTERNALSYM PCTSTR}
  LPCTSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPCTSTR{$ELSE}LPCSTR{$ENDIF};
  {$EXTERNALSYM LPCTSTR}

  PCUTSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPCSTR{$ELSE}LPCSTR{$ENDIF};
  {$EXTERNALSYM PCUTSTR}
  LPCUTSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPCSTR{$ELSE}LPCSTR{$ENDIF};
  {$EXTERNALSYM LPCUTSTR}
  PUTSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPCSTR{$ELSE}LPCSTR{$ENDIF};
  {$EXTERNALSYM PUTSTR}
  LPUTSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPCSTR{$ELSE}LPCSTR{$ENDIF};
  {$EXTERNALSYM LPUTSTR}
...
//
  ...
  PUCHAR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PUCHAR{$ELSE}^UCHAR{$ENDIF};
  {$EXTERNALSYM PUCHAR}
  PUSHORT = ^USHORT;
  {$EXTERNALSYM PUSHORT}
  PULONG = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PULONG{$ELSE}^ULONG{$ENDIF};
  {$EXTERNALSYM PULONG}
  PUQUAD = ^UQUAD;
  {$EXTERNALSYM PUQUAD}
...
//
  ...
  HANDLE = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.THandle{$ELSE}Longword{$ENDIF};
  {$EXTERNALSYM HANDLE}
  PHANDLE = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PHandle{$ELSE}^HANDLE{$ENDIF};
  {$EXTERNALSYM PHANDLE}
  THandle = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.THandle{$ELSE}HANDLE{$ENDIF};
...
//
  ...
  LCID = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LCID{$ELSE}ULONG{$ENDIF};
  {$EXTERNALSYM LCID}
  PLCID = {$IFDEF USE_DELPHI_TYPES}^LCID{$ELSE}PULONG{$ENDIF};
  {$EXTERNALSYM PLCID}
  LANGID = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LANGID{$ELSE}USHORT{$ENDIF};
  {$EXTERNALSYM LANGID}
...
{$IFDEF USE_DELPHI_TYPES}
  _LARGE_INTEGER = WinApi.Windows._LARGE_INTEGER;
  LARGE_INTEGER = WinApi.Windows.LARGE_INTEGER;
  TLargeInteger = WinApi.Windows.TLargeInteger;
{$ELSE}
...
{$IFDEF USE_DELPHI_TYPES}
  ULARGE_INTEGER = WinApi.Windows.ULARGE_INTEGER;
  TULargeInteger = WinApi.Windows.TULargeInteger;
  PULargeInteger = WinApi.Windows.PULargeInteger;
{$ELSE}
...
{$IFDEF USE_DELPHI_TYPES}
  _LIST_ENTRY = WinApi.Windows._LIST_ENTRY;
  LIST_ENTRY = WinApi.Windows.LIST_ENTRY;
  TListEntry = WinApi.Windows.TListEntry;
  PListEntry = WinApi.Windows.PListEntry;
{$ELSE}
  _LIST_ENTRY = record
    Flink: PLIST_ENTRY;
    Blink: PLIST_ENTRY;
...
//unsigned short      WORD;
  ...
  PFLOAT = ^FLOAT;
  {$EXTERNALSYM PFLOAT}
  PBOOL = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PBOOL{$ELSE}^BOOL{$ENDIF};
  {$EXTERNALSYM PBOOL}
  LPBOOL = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PBOOL{$ELSE}^BOOL{$ENDIF};
  {$EXTERNALSYM LPBOOL}
  PBYTE = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PBYTE{$ELSE}^BYTE{$ENDIF};
  {$EXTERNALSYM PBYTE}
  LPBYTE = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PBYTE{$ELSE}^BYTE{$ENDIF};
  {$EXTERNALSYM LPBYTE}
  PINT = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PINT{$ELSE}^INT{$ENDIF};
  {$EXTERNALSYM PINT}
  PUINT = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PUINT{$ELSE}^UINT{$ENDIF};
  {$EXTERNALSYM PUINT}
  LPUINT = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PUINT{$ELSE}^UINT{$ENDIF};
  {$EXTERNALSYM LPUINT}
  LPINT = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PINT{$ELSE}^INT{$ENDIF};
  {$EXTERNALSYM LPINT}
  PWORD = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PWORD{$ELSE}^WORD{$ENDIF};
  {$EXTERNALSYM PWORD}
  LPWORD = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PWORD{$ELSE}^WORD{$ENDIF};
  {$EXTERNALSYM LPWORD}
  LPLONG = ^LONG;
  {$EXTERNALSYM LPLONG}
  PDWORD = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PDWORD{$ELSE}^DWORD{$ENDIF};
  {$EXTERNALSYM PDWORD}
  LPDWORD = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPDWORD{$ELSE}^DWORD{$ENDIF};
  {$EXTERNALSYM LPDWORD}
  LPVOID = Pointer;
  {$EXTERNALSYM LPVOID}
  LPCVOID = Pointer;
  ...
  INT = Integer;
  {$EXTERNALSYM INT}
  UINT = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.UINT{$ELSE}Longword{$ENDIF};
  {$EXTERNALSYM UINT}

// Types use for passing & returning polymorphic values

  WPARAM = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.WPARAM{$ELSE}UINT_PTR{$ENDIF};
  {$EXTERNALSYM WPARAM}
  LPARAM = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LPARAM{$ELSE}LONG_PTR{$ENDIF};
  {$EXTERNALSYM LPARAM}
  LRESULT = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.LRESULT{$ELSE}LONG_PTR{$ENDIF};
  {$EXTERNALSYM LRESULT}
...
type
  HWND = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HWND{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HWND}
  LPHWND = ^HWND;
  {$EXTERNALSYM LPHWND}
  HHOOK = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HHOOK{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HHOOK}
  LPHHOOK = ^HHOOK;
  {$EXTERNALSYM LPHHOOK}
  HEVENT = HANDLE;
  ...
  ATOM = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.ATOM{$ELSE}WORD{$ENDIF};
  {$EXTERNALSYM ATOM}
  ...
  HGLOBAL = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HGLOBAL{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HGLOBAL}
  HLOCAL = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HLOCAL{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HLOCAL}
  GLOBALHANDLE = HANDLE;
  {$EXTERNALSYM GLOBALHANDLE}
  //LOCALHANDLE = HANDLE; // todo clashes with WinBase.LocalHandle function
  //{$EXTERNALSYM LOCALHANDLE}
  FARPROC = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.FARPROC{$ELSE}function: Integer{$ENDIF};
  {$EXTERNALSYM FARPROC}
  ...
  HGDIOBJ = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HGDIOBJ{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HGDIOBJ}

  HKEY = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HKEY{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HKEY}
  PHKEY = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PHKEY{$ELSE}^HKEY{$ENDIF};
  {$EXTERNALSYM PHKEY}

  HACCEL = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HACCEL{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HACCEL}

  HBITMAP = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HBITMAP{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HBITMAP}
  HBRUSH = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HBRUSH{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HBRUSH}

  HCOLORSPACE = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HCOLORSPACE{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HCOLORSPACE}

  HDC = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HDC{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HDC}
  HGLRC = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HGLRC{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HGLRC}
  HDESK = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HDESK{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HDESK}
  HENHMETAFILE = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HENHMETAFILE{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HENHMETAFILE}
  HFONT = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HFONT{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HFONT}
  HICON = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HICON{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HICON}
  HMENU = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HMENU{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HMENU}
  HMETAFILE = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HMETAFILE{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HMETAFILE}
  HINSTANCE = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HINST{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HINSTANCE}
  HMODULE = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HMODULE{$ELSE}HINSTANCE{$ENDIF};
  {$EXTERNALSYM HMODULE}
  HPALETTE = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HPALETTE{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HPALETTE}
  HPEN = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HPEN{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HPEN}
  HRGN = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HRGN{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HRGN}
  HRSRC = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HRSRC{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HRSRC}
  HSTR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HSTR{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HSTR}
  HTASK = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HTASK{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HTASK}
  HWINSTA = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HWINSTA{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HWINSTA}
  HKL = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HKL{$ELSE}HANDLE{$ENDIF};
  {$EXTERNALSYM HKL}
  ...
  HFILE = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HFILE{$ELSE}Integer{$ENDIF};
  {$EXTERNALSYM HFILE}
  HCURSOR = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.HCURSOR{$ELSE}HICON{$ENDIF};
  {$EXTERNALSYM HCURSOR}

  COLORREF = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.COLORREF{$ELSE}DWORD{$ENDIF};
...
type
  ...
  {$EXTERNALSYM tagRECT}
  RECT = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.TRect{$ELSE}tagRECT{$ENDIF};
  {$EXTERNALSYM RECT}
  NPRECT = ^RECT;
  {$EXTERNALSYM NPRECT}
  LPCRECT = ^RECT;
  {$EXTERNALSYM LPCRECT}
  TRect = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.TRect{$ELSE}RECT{$ENDIF};
  PRect = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PRect{$ELSE}LPRECT{$ENDIF};
  ...
  POINT = tagPOINT;
  {$EXTERNALSYM tagPOINT}
  TPoint = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.TPoint{$ELSE}POINT{$ENDIF};
  PPoint = {$IFDEF USE_DELPHI_TYPES}WinApi.Windows.PPoint{$ELSE}LPPOINT{$ENDIF};
...
begin
  ...
  begin
    ...
    P := GetProcAddress(ModuleHandle, PAnsiChar(AnsiString(ProcName)));
